...
{
    /// Initialisation des boutons et des entites graphiques
...
{
    /// Detection d'evenement relatif au menu
    ...
    } /// Detection de la fermeture du menu
...
{
    /// Affichage des elements graphiques du menu
    checkOpen(window);
    if(open){
